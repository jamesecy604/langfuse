...
export function TracePageNotInProject({
  traceId,
  timestamp,
  projectId,
  userId,
          ...
          <>
            <DetailPageNav
              ...
              path={(entry) => {
                ...
                return projectId
                  ? `/project/${projectId}/traces/${entry.id}${queryParamString}${timestamp ? `?timestamp=${timestamp}` : ""}`
                  : `/traces/${entry.id}${queryParamString}${timestamp ? `?timestamp=${timestamp}` : ""}`;
              }}
              listKey="traces"
            />
            {hasTraceDeletionEntitlement && (
              <DeleteButton
                ...
                type="trace"
                redirectUrl={
                  projectId ? `/project/${projectId}/traces` : "/traces"
                }
